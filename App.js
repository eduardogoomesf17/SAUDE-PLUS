...
export default function App() {
  ...
  const imcDescriptionMessage = {
    low: 'abaixo do peso',
    normal: ' com o peso normal',
    atention: 'com sobrepeso',
    fat1: 'na obesidade grau 1',
    fat2: 'na obesidade grau 2',
    fat3: 'na obesidade grau 3'
  }
      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <View>
          ...
          <TextInputMask 
            ...
            options={{ mask: '99,999' } }
            value={weight.value}
            onChangeText={(weightInput) => { setWeight({ value: weightInput }) }}
          ...
          <TextInputMask 
            ...
            options={{ mask: '9,99' }}
            value={height.value}
            onChangeText={(heightInput) => { setHeight({ value: heightInput }) }}
            keyboardType='number-pad'
            autoFocus={true}
          />
